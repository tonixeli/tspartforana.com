	...
	if(!empty($_POST))
	{
		...
		if(empty($_POST['nombre']) || empty($_POST['pueblo']))
		{
			...
			if($result > 0){
				...
				$query_insert = mysqli_query($conection, "INSERT INTO usuarios (estado, nombre, dni, pueblo, direccion, telefono, nombre_familiar, telefono_familiar, nombre_familiar2, telefono_familiar2, alta, tipo_sad, grado, copago, horas_atencion_personal, horas_atencion_hogar) VALUES ('$estado','$nombre','$dni','$pueblo','$direccion','$telefono','$nombre_familiar','$telefono_familiar','$nombre_familiar2','$telefono_familiar2','$alta','$tipo_sad','$grado','$copago','$horas_atencion_personal','$horas_atencion_hogar')");
