	...
	if(!empty($_POST))
	{
		...
		if( empty($_POST['usuario']) || empty($_POST['clave']) )
		{
			...
			if($result > 0){
				...
				$query_insert = mysqli_query($conection,"INSERT INTO `empleados`(`dni`, `nss`, `nombre`, `correo`, `usuario`, `clave`, `rol`, `cargo`, `fecha_nacimiento`, `telefono`, `direccion`, `localidad`, `fecha_alta`, `tipo_contrato`, `jornada_semanal`, `salario_mensual`) VALUES ('$dni', '$nss', '$nombre', '$correo', '$usuario', '$clave', '$rol', '$cargo', '$fecha_nacimiento', '$telefono', '$direccion', '$localidad', '$fecha_alta', '$tipo_contrato', '$jornada_semanal', '$salario_mensual')");
				if($query_insert){
				...
				<table>
					<tr>
						...
						<td>
							...
							<input type="text" name="cargo" id="cargo" placeholder="Cargo del empleado" required>
						</td>
					</tr>
				...
				<table>
					<tr>
						<td>
							...
							<input type="text" name="tipo_contrato" id="tipo_contrato" placeholder="Tipo de Contrato" required>							
						</td>
						<td>
